...
# 
# Run the docker
docker kill dk_service_can_provider; docker rm dk_service_can_provider ; docker run -d -it --name dk_service_can_provider --net=host -e KUKSA_ADDRESS=localhost -e MAPPING_FILE=mapping/vss_3.0/vss_dbc.json -e LOG_LEVEL=INFO -e KUKSA_ADDRESS=localhost -e CAN_PORT=vcan0 dk_service_can_provider
```
