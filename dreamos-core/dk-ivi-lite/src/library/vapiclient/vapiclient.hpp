...
namespace VehicleAPI {
    ...
    inline constexpr const char* V_Bo_Lights_Brake_IsOn                  = "Vehicle.Body.Lights.IsBrakeOn";
    inline constexpr const char* V_Bo_Lights_Hazard_IsSignaling          = "Vehicle.Body.Lights.IsHazardOn";
    inline constexpr const char* V_Ca_HVAC_Station_R1_Driver_FanSpeed    = "Vehicle.Cabin.HVAC.Station.Row1.Left.FanSpeed";
